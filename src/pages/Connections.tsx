      ...
      <main className="flex-grow w-full px-6 sm:px-10 md:px-14 py-8 sm:py-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {filteredConnections.map((conn, idx) => (
            ...
            >
              <motion.div
                ...
                className="group cursor-pointer flex items-center gap-4 p-6 bg-[var(--surface)] border border-[var(--border)] hover:border-[var(--accent)] rounded-2xl transition-colors duration-300 shadow-sm hover:shadow-md"
              >
                {conn.avatar_image ? (
                  <motion.img
          ...
          {filteredConnections.length === 0 && (
            <div className="col-span-full py-12 text-center text-[var(--secondary)] font-body">
